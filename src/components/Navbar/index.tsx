    ...
    <Menu>
      ...
      <Menu.Items className={styles.BurgerMenuItemsOverlay}>
        <div className={styles.BurgerMenuItems}>
          <BurgerMenuItem href="/">Staking</BurgerMenuItem>
          <BurgerMenuItem href="/statistics">{messages.en.Stats}</BurgerMenuItem>
          <BurgerMenuItem href="/faq">FAQ</BurgerMenuItem>
          <BurgerMenuItem href="/dex">Dex</BurgerMenuItem>
          <BurgerMenuItem style={{
            display: bills?.length ? undefined : 'none'
          }} href="/bills">Bills</BurgerMenuItem>
        </div>
      </Menu.Items >
    </Menu >
  );
    ...
    <nav className={styles.Navbar}>
      <div className={styles.NavbarContainer}>
        <div className={styles.NavbarStart}>
          ...
          <Link className={styles.NavbarItem} href="/">Staking</Link>
          <Link className={styles.NavbarItem} href="/statistics">{messages.en.Stats}</Link>
          <Link className={styles.NavbarItem} style={{
            display: bills?.length ? undefined : 'none'
          }} href="/bills">Bills</Link>
          <Link className={styles.NavbarItem} href="/faq">FAQ</Link>
          <Link className={styles.NavbarItem} href="/dex">Dex</Link>
          <Suspense fallback={<></>}>
            <ShowInDebug>
              <Link className={styles.NavbarItem} href="/explorer" style={{ color: 'blue' }}>Explorer</Link>
            </ShowInDebug>
            <ShowInDebug>
