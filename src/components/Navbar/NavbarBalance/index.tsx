  ...
  return (
    <NavbarBadgeCard>
      <div className={styles.NavBarBalanceLogoWrapper}>
        <img src="/icons/mevton.svg" aria-hidden />
      </div>
      <div className={styles.NavbarBalanceData}>
        <NavbarBadgeCard.Label>
          <AnimatedNumber value={model.mtonBalanceNormal()} formatValue={formatCryptoAmountAbbr} duration={300} /> {messages.en.mevTon}

        </NavbarBadgeCard.Label>

        <NavbarBadgeCard.Value >
          <AnimatedNumber value={model.mtonBalanceInUsd()} formatValue={formatCryptoAmountAbbr} duration={300} /> USDT
